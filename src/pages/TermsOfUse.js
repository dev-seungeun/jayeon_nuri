        ...
        <>
            ...
            <div className="add_wrap">
                ...
                <div className="use_cont">
                    ...
                    <br/><br/>
                    - 4세 이상부터는 추가인원에 해당되며, 또한 숙박을 하지 않더라도 추가 인원에 해당 됩니다. (추가요금 : 1인 {addPersonPrice && addPersonPrice.toLocaleString()}원)
                    <br/><br/>
                    ...
                    <br/><br/>
                    - 숯불이용 (4인기준) : {grilledPrice && grilledPrice.toLocaleString()}원
                </div>
